                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> <?php echo "CFA".$item_total; ?></strong></td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="bank" disabled class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Bank <img src="images/paypal.jpg" alt="" width="90"></span> </label>
                                            </li>
                                        </ul>
